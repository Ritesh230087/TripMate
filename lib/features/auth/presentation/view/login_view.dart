...
import 'package:tripmate/features/auth/presentation/view/forgot_password_view.dart';
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                // Google Sign In - WITH LOGIC INTEGRATED
                SizedBox(
                  width: double.infinity,
                  height: 50,
                  child: OutlinedButton(
                    onPressed: () {
                      // Integrated Google Logic
                      context.read<LoginViewModel>().add(
                      ...
                      TextSpan(
                        ...
                        recognizer: TapGestureRecognizer()
                          ..onTap = () => context.read<LoginViewModel>().add(
                            NavigateToRegisterEvent(context: context),
                          ),
                      ),
                    ],
                  ),
