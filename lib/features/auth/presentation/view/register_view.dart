        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
             ...
             // Replace the Profile Picture section with this updated code:
...
_image == null 
        ...
        children: [
          ...
          Expanded(
            child: Text(
              ...
              style: GoogleFonts.inter(color: const Color(0xFF8B8B8B), fontSize: 15)
            )
          ),
          ElevatedButton(
  ...
  : Container(
      ...
      child: Stack(
        children: [
          // ✅ ClipRRect to ensure image respects border radius
          ClipRRect(
