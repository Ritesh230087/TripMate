...
//   void initState() {
//     super.initState();
//     // Trigger location load when page starts
...
//               // Default to Kathmandu if location not found yet
//               final LatLng center = state.currentLocation ?? const LatLng(27.7172, 85.3240);
...
//                 onPressed: () {
//                   // Open Drawer code here later
//                 },
//               ),
//             ),
//           ),

//           // --- 3. BOTTOM SHEET "Where to?" ---
//           DraggableScrollableSheet(
//             initialChildSize: 0.35, // Height when first opened
//             minChildSize: 0.35,
//             maxChildSize: 0.9,
...
//                       ),
//                       child: TextField(
//                         enabled: false, // Make it clickable later to open full search page
...
//                       title: "Home",
//                       subtitle: "Balaju, Kathmandu",
//                       iconColor: const Color(0xFF8B4513),
//                       bgColor: const Color(0xFFF9F5E9),
//                     ),
...
//   Widget _buildPlaceItem({required IconData icon, required String title, required String subtitle, required Color iconColor, required Color bgColor}) {
//     return Row(
//       children: [
//         Container(
//           padding: const EdgeInsets.all(12),
//           decoration: BoxDecoration(
//             color: bgColor, // Beige circle
//             shape: BoxShape.circle,
//           ),
